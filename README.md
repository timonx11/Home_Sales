...
## Please note that all code for this challenge is stored on the Home_Sales_colab. Files needs to be run / open on Google Collab as I have issues installing tensorflow on my local
